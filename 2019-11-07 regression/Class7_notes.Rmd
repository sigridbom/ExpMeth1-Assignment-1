...
```{r}
summary(lm(child$Aggression ~ child$Television, data = child))
summary(lm(child$Aggression ~ child$Computer_Games, data = child))
summary(lm(child$Aggression ~ child$Sibling_Aggression, data = child))
summary(lm(child$Aggression ~ child$Diet, data = child))
summary(lm(child$Aggression ~ child$Parenting_Style, data = child)) 
...
ggplot(child, aes(child$Computer_Games, Aggression)) + 
  geom_point() + 
  geom_smooth(method = lm) + #fit the best straight line to the data
  ggtitle('Scatter plot with the regression line: quicker using geom_smooth (method lm)')

ggplot(child, aes(child$Sibling_Aggression, child$Aggression)) + 
  geom_point() + 
  geom_smooth(method = lm) + #fit the best straight line to the data
  ggtitle('Scatter plot with the regression line: quicker using geom_smooth (method lm)')

ggplot(child, aes(child$Diet, Aggression)) + 
  geom_point() + 
  geom_smooth(method = lm) + #fit the best straight line to the data
  ggtitle('Scatter plot with the regression line: quicker using geom_smooth (method lm)')

ggplot(child, aes(child$Parenting_Style, Aggression)) + 
  geom_point() + 
  geom_smooth(method = lm) + #fit the best straight line to the data
  ggtitle('Scatter plot with the regression line: quicker using geom_smooth (method lm)')

#child diet is the worst
...
#1
model1 <- lm(child$Aggression ~ child$Parenting_Style, data = child)
summary(model1)
#beta child parenting: 0,067

#2
model2 <- lm(child$Aggression ~ child$Parenting_Style + child$Computer_Games, child)
summary(model2)
#beta 0,057

#3
model3 <- lm(child$Aggression ~ child$Parenting_Style + child$Computer_Games + child$Television, child)
summary(model3)
# 0,048
