...
The value Shapiro Wilk's test for condition 1 is 0.77 with a significant p-value (p<0,05), which means that the data is significantly different from a normal distribution. The same applies for condition 2 except the value of the test is 0.56.
...
The values of skew.2SE and kurt.2SE for all four data sets are all between [-1;1] which is supporting a normal distribution. 
...
When conducting an independent t-test I have found that the average reading time for the expected and unexpected word is not significantly increased by the unexpected word, t(23.98) = -0.63, p>0.05, (mean expected = 0.57, mean unexpected = 0.50)

The same goes for the word following the expected and unexpected word, t(22.62) = 1.01, p>0.05, (mean expected = 0.48, mean unexpected = 0.56).
